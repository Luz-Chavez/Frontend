...
function CreateCategoryModal({ onClose, onCrearCategoria }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ margin: 0, fontSize: "1.3rem", fontWeight: 700 }}>Crear nueva categoría</h2>
