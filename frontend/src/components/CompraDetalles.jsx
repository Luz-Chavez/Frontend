...
// Componente para mostrar los detalles de una compra
export default function CompraDetalles({ detalles = [], productos = {} }) {
  // productos: objeto opcional para mostrar el nombre del producto si está disponible
  return (
    <div style={boxStyle}>
      <h4 style={titleStyle}>Detalles de la Compra</h4>
      <table style={tableStyle}>
        ...
        <tbody>
          {detalles.length === 0 ? (
            ...
            detalles.map((d) => (
              <tr key={d.id_detalle_compra} style={{ borderBottom: '1px solid #E5E7EB' }}>
