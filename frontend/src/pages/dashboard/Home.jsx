    ...
    async function fetchData() {
      if (user?.rol === 'adminmicroempresa' && user?.microempresa?.id_microempresa) {
        try {
          ...
          console.log('Respuesta microempresa:', empresaRes.data);
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <span style={{
                      ...
                      fontSize: 14,
                      fontWeight: 700,
                      background: empresa && empresa.estado === true ? '#1D7373' : '#F87171',
                      color: '#fff',
                      marginTop: 2
                    }}>{empresa && empresa.estado === true ? 'Activo' : 'Inactivo'}</span>
                  </div>
                  <div>
